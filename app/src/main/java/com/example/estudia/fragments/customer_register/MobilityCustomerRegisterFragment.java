...
public class MobilityCustomerRegisterFragment extends Fragment {

    private OnFragmentCustomerRegisterInteractionListener mListener;
    Button yesButton, noButton;

    public MobilityCustomerRegisterFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mobility_customer_register, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        yesButton = view.findViewById(R.id.yesButtonMobilityFragment);
        noButton = view.findViewById(R.id.noButtonMobilityFragment);
